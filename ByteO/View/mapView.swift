...
//struct MapView: View {
//    @Environment(\.gameDataStore) var gameData
...
//        // 1) أنشئ متجراً تجريبيّاً
//        let previewStore = GameDataStore()
//        // 2) جهّز له بيانات رؤية سريعة
//        let p = PlayerProgress()
//        p.currentTrackIndex = 0
//        p.currentLevelIndex = 0
//        p.coins = 30
//        previewStore.playerProgress = p
//
//        // 3) حقنه في الـ Preview
//        return MapView()
//            .environment(\.gameDataStore, previewStore)
//    }
//}
//#endif
